...
- Debes enviar tu solución como un **repositorio PRIVADO en GitHub** e invitar a **--** como colaborador. También puedes intentarlo con el nombre de usuario **--**.
...
- Entender los requisitos también es parte de la prueba. Para cualquier otro problema, comunícate con **--** para obtener ayuda.
